...
В верхней панели доступен переключатель:

- `Галерея` — современный выставочный режим с адаптивной masonry-лентой;
- `Классический` — прежний интерфейс S-Art.

Выбор хранится в `localStorage` браузера и не изменяет публикации или другие
данные. Git-метка `ui-classic-2026-07-26` сохраняет исходную версию GUI для
полного технического отката.
