    ...
    <section class="help-dialog glass-card" role="dialog" aria-modal="true" aria-labelledby="guide-title">
      ...
      <div class="guide-content">
        ...
        <section>
          ...
          <p><b>Стиль интерфейса.</b> Кнопка «Классический»/«Галерея» в верхней панели переключает новый выставочный вид и прежнее оформление. Выбор сохраняется в браузере.</p>
        </section>
