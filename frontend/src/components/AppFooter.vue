    ...
    <section class="help-dialog glass-card" role="dialog" aria-modal="true" aria-labelledby="guide-title">
      ...
      <div class="guide-content">
        ...
        <section>
          ...
          <p>Работы распределяются по рубрикам: <b>Иллюстрации</b>, <b>Персонажи</b>, <b>Городские сюжеты</b>, <b>Природа и пейзажи</b>, <b>Фэнтези</b>, <b>Портреты</b>, <b>Архитектура и интерьеры</b>, <b>Абстракция и эксперименты</b>, <b>Животные</b>, <b>Еда и натюрморты</b>, <b>Технологии и транспорт</b> и <b>Прочее</b>.</p>
          <p><b>Design Lab.</b> Пункт «Дизайн» открывает три независимых оформления ленты: Digital Gallery, Neo-Art Studio и Creative Canvas. Классический режим всегда доступен как резервный.</p>
        </section>
